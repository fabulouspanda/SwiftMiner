...
//  MacMiner
//
//  Created by Administrator on 05/06/2014.
//  Copyright (c) 2014 fabulouspanda. All rights reserved.
//
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    @IBOutlet var rateDisplay: NSTextField
    ...
    func applicationDidFinishLaunching(aNotification: NSNotification?) {
        ...
        println("App Launch")
//        rateDisplay.stringValue = "hi"
        
    }

    func applicationWillTerminate(aNotification: NSNotification?) {
        // Insert code here to tear down your application
                println("I'm sploding!")
    }
    ...
    var managedObjectModel: NSManagedObjectModel {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("MacMiner", withExtension: "momd")
    ...
    var persistentStoreCoordinator: NSPersistentStoreCoordinator? {
        ...
        let url = applicationFilesDirectory.URLByAppendingPathComponent("MacMiner.storedata")
